                    ...
                    <div class="card-body">
                        ...
                        <?php echo form_close() ?>
                            ...
                            <div class="row">
                                ...
                                $def_mods = ['Account','Auth','CMS','Common','Addon','Exchange','Finance','Gourl','Package','Payeer','Paypal','Paystack','Phone','Setting','Stripe','System_user','User','Website'];
                                if (is_array($map))
                                            ...
                                            <div class="thumbnail">
                                              ...
                                              <div class="caption">
                                                ...
                                                <p>
                                                    ...
                                                    ?>
                                                    <a onclick="return confirm('<?php echo display("are_you_sure") ?>')"  href="<?php echo base_url("backend/module/uninstall/$delMod") ?>" class="btn btn-danger"><?php echo display("uninstall") ?></a> 
                                                    <?php } else {
...
<script src="<?php echo base_url().'/app/Modules/Addon/assets/ajaxs/addons/module.js?v=1' ?>"></script>
