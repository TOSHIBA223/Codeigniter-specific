            ...
            <div class="card-body">
                ...
                <div class="border_preview">
                        ...
                        <div class="settingWrapper">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                <label class="col-form-label ">For Payout</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="copyed1" value="curl --request GET <?php echo base_url();?>/customer/auto_commission/payout" readonly>
                                ...
                                <div class="col-form-label col-sm-6">
                                    <label class="col-form-label ">For Crypto Currency</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="copyed2" value="curl --request GET <?php echo base_url("backend/currency/Currency_cronjob") ?>" readonly>
                                        <span class="input-group-btn">
