                ...
                <table id="example" class="table display table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url("backend/externalapi/external_api_setup/$value->id") ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-cog" aria-hidden="true"></i> Setup</a>
                            </td>
                        </tr>
                        <?php } ?>  
                    </tbody>
