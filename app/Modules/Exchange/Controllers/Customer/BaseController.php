...
use App\Modules\Exchange\Models\Customer\Buy_model;
use App\Modules\Exchange\Models\Customer\Currency_model;
use App\Modules\Exchange\Models\Customer\Sell_model;
...
class BaseController extends Controller
{
	...
	public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
	{
		...
		$this->BASE_VIEW 	 = "App\Modules\Exchange\Views\Customer";

		//Creating Model object
		$this->template 		= new Template();
		$this->common_model 	 = new Common_model();
		$this->buy_model 	 = new Buy_model();
		$this->sell_model 	 = new Sell_model();
