...
<div class="form-group row">
    <label for="wallet_id" class="col-sm-4 col-form-label">Company <i><?php echo isset($selectedexccurrency->coin_name)?esc($selectedexccurrency->coin_name):''; ?></i> <?php echo display("wallet_data") ?></label>
    <div class="col-sm-8">
        <input name="wallet_id" class="form-control" type="text" id="wallet_id" value="<?php echo isset($selectedexccurrency->wallet_data)?esc($selectedexccurrency->wallet_data):''; ?>" autocomplete="off" disabled>
    </div>
</div>