    ...
    <div class="col-md-12 col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart(base_url("backend/faq/info/$article->article_id")) ?>
                <?php echo form_hidden('article_id', esc($article->article_id)) ?> 
                    ...
                    <div class="form-group row">
                        <label for="headline_fr" class="col-sm-2 col-form-label"><?php echo display('question')." ".esc($web_language->name) ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label"><?php echo display('answer')." ".esc($web_language->name) ?></label>
                        <div class="col-sm-10">
