...
?>
                        <div class="post post_list post_list_sm">
                            <div class="post_img">
                                <a href="<?php echo base_url($this->uri->getSegment(1).'/'.esc($cat_slug->slug)."/$slug"); ?>"><img src="<?php echo base_url(esc($news_article_image)); ?>" alt="<?php echo strip_tags(esc($news_headline)); ?>"></a>
                            </div>
                            <div class="post_body">
                                <h4 class="post_heading"><a href="<?php echo base_url($this->uri->getSegment(1).'/'.esc($cat_slug->slug)."/$slug"); ?>"><?php echo strip_tags(esc($news_headline)); ?></a></h4>
                                <div class="post_meta">
                        ...
                        <div class="widget">
                            ...
                            <div class="social_icon">
                                <?php foreach ($social_link as $key => $value) { ?>
                                    <a href="<?php echo esc($value->link); ?>" class="<?php echo esc($value->icon); ?>"><i class="fa fa-<?php echo esc($value->icon); ?>"></i></a>
                                <?php } ?>
                            </div>
