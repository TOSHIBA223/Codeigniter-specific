                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($value->status==1){?>
                                 ...
                                 <i class="text-success fas fa-check fadeAnim" title="Confirm"></i>
                                 <?php } else{ ?>
                                 <i class="text-danger fas fa-times fadeAnim" title="Cancel"></i>
                                 <?php } ?>
                             </td>
                             <td>
                                 <?php if($value->status==1){?>
                                 <a href="<?php echo base_url()?>/admin/confirm_withdraw?id=<?php echo $value->withdraw_id;?>&user_id=<?php echo $value->user_id;?>&set_status=2" class="btn btn-success btn-sm"><?php echo display('confirm')?></a>
                                 <?php }
...
<script src="<?php echo base_url("app/Modules/Finance/Assets/Admin/js/custom.js") ?>"></script>