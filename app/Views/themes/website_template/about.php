                ...
                <div class="row about-text justify-content">
                    <div class="col-md-6">
                        <div class="about-info">
                            ...
                            <div class="play-button">
                                <a href="<?php echo esc(@$article_video[0]); ?>" class="btn-play popup-youtube">
                    ...
                    <div class="col-md-6">
                        <div class="text-right">
                            <img src="<?php echo base_url(esc(@$article_image[1])); ?>" class="img-responsive" alt="<?php echo strip_tags(htmlspecialchars_decode(@$headline[1])); ?>">
                        </div>
                        <div class="quote">
                            <?php echo @$article1[1]; ?>
...
?>
                            <div class="col-sm-4 team">
                                <h2 class="team__number">0<?php echo esc($position_serial); ?></h2>
                                <div class="team__member">
                                    <a href="#" class="team__member__img" style="background-image: url(<?php echo base_url(esc($tea_article_image)); ?>)"></a>
                                </div>
...
?>
                            <div class="logo-item">
                                <a href="<?php echo htmlspecialchars_decode($cli_article1); ?>" target="_blank"><img src="<?php echo base_url(esc($cli_article_image)); ?>" class="img-responsive" alt="<?php echo strip_tags(esc($cli_headline)); ?>"></a>
                            </div>
<?php
