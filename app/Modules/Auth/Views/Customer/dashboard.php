...
<link href="<?php echo base_url("app/Modules/Auth/Assets/Customer/css/custom.css") ?>" rel="stylesheet" type="text/css" />
<div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="copyed" value="<?php echo base_url()?>/register?ref=<?php echo $session->get('user_id')?>">
...
<?php  if(@$level_info->level!=NULL AND $level_info->level!=0){ ?>
    ...
    <div class="col-sm-6 award-img">
       ...
       <a href="<?php echo base_url()?>/customer/account/mylevel_info"><img src="<?php echo base_url()?>/public/assets/award/0<?php echo esc(@$level_info->level); ?>.png"></a>
    </div>
</div>
<?php } ?>
</div>
...
<div class="social_share">
    <ul>
        <li class="whatsapp"><a href="<?php echo base_url()?>/customer/account/my_payout"> <span><?php echo display('my_payout')?> $<?php echo (@$my_earns?number_format(esc($my_earns), 2):'0.0');?></span></a></li>
        <li class="facebook"><a href="<?php echo base_url()?>/customer/account/my_commission"> <span><?php echo display('commission')?> $<?php echo (@$commission?number_format(esc($commission), 2):'0.0');?></span></a></li>
        <li class="twitter"><a href="<?php echo base_url()?>/customer/account/team_bonus"> <span><?php echo display('bonus')?>  $<?php echo ($team_bonus?number_format(esc($team_bonus), 2):'0.0');?></span></a></li>
    </ul>
</div>
...
<div class="row">
    ...
    <div class="col-sm-6 col-md-3">
        <div class="count_panel">
            ...
            <h1 class="currency_text text-warning">$<?php echo (@$withdraw!=0?number_format(esc($withdraw), 2):'0.0');?></h1>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3">
        <div class="count_panel">
            ...
            <h1 class="currency_text text-success">$<?php echo (@$team_commission!=0?number_format(esc($team_commission), 2):'0.0');?></h1>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3">
        <div class="count_panel">
            ...
            <h1 class="currency_text text-success">$<?php echo (@$sponser_commission!=0?number_format(esc($sponser_commission), 2):'0.0');?></h1>
        </div>
    </div>
            ...
            <div class="item">
                <div class="pricing__item shadow navy__blue_<?php echo $i++;?>">
                    ...
                    <ul class="pricing__feature-list">
                        <li class="pricing__feature"><?php echo display('period');?> <span><?php echo esc($value->period);?> day</span></li>
                    ...
                    <table  class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url()?>/customer/account/payout_receipt/<?php echo esc($value->earning_id);?>" class="btn btn-success btn-xs">View</a></td>
                            </tr>
                            ...
                            <table  class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo esc(@$info['sponser_info']->f_name).' '.esc(@$info['sponser_info']->l_name);?></td>
                                    </tr>
                                    <tr>
                ...
                <div class="table-responsive">
                    <table  class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo display('name');?></td>
                                <td><?php echo esc($info['my_info']->f_name).' '.esc($info['my_info']->l_name);?></td>
                            </tr>
                            <tr>
                                <td><?php echo display('email');?></td>
...
<script src="<?php echo base_url("app/Modules/Auth/Assets/Customer/js/custom.js?v=1") ?>" type="text/javascript"></script>