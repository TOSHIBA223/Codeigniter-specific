        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                             <a class="btn btn-success w-md m-b-5" href="<?php echo base_url("customer/sell/sell_list") ?>"><i class="fa fa-list" aria-hidden="true"></i> <?php echo display("sell_list") ?></a>
            ...
            <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php echo form_open_multipart(base_url("customer/sell/sell_form"),array('id'=>'sell_form')); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 " align="center">
                                ...
                                <a href="<?php echo base_url('customer/sell/sell_list'); ?>" class="btn btn-primary  w-md m-b-5"><?php echo display("cancel") ?></a>
                            </div>
                        </div>
                        <?php echo form_close() ?>
                    </div>
