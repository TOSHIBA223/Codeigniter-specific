<link href="<?php echo base_url("app/Modules/Finance/Assets/Customer/css/custom.css?v=1.3") ?>" rel="stylesheet">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                        ...
                        <div class="border_preview">
                            <div class="form-group row">
                                <label for="receiver_id" class="col-sm-4 col-form-label"><?php echo display('reciver_account')?><span class='text-danger'> *</span></label>
                                <div class="col-sm-8">
