    ...
    <div class="col-md-12 col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart(base_url("backend/news/info/$article->article_id")) ?>
                <?php echo form_hidden('article_id', esc($article->article_id)) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="article_image" class="form-control" placeholder="<?php echo display('image') ?>" type="file" id="article_image">
                             ...
                             <?php } ?>
                                <div class="text-danger">290x205 px(jpg, jpeg, png, gif, ico)</div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control basic-single" name="cat_id">
                                ...
                                <?php foreach ($child_cat as $key => $value) { ?>
                                    <option value="<?php echo esc($value->cat_id); ?>" <?php echo ($article->cat_id==$value->cat_id)?'Selected':'' ?>><?php echo $value->cat_name_en; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="row" align="center">
                        <div class="col-sm-12 col-sm-offset-3">
                            <a href="<?php echo base_url('admin/dashboard'); ?>" class="btn btn-primary  w-md m-b-5"><?php echo display("cancel") ?></a>
