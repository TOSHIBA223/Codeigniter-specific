...
$ADMINMENU['exchange'] = array(
    ...
    'submenu'       => array(
                '0' => array(
                    'name'          => 'Exchange',
                    'icon'          => null,
                    'link'          => 'exchange/exchange_list',
                    'segment'       => 3,
                    'segment_text'  => 'exchange_list',
                ),
                '1' => array(
                ...
                '2' => array(
                    'name'          => 'Local Currency',
                    'icon'          => null,
                    'link'          => 'currency/local_currency',
                    'segment'       => 3,
                    'segment_text'  => 'local_currency',
                ),
                '3' => array(
                    'name'          => 'Exchange Wallet',
                    'icon'          => null,
                    'link'          => 'exchange/exchange_wallet',
                    'segment'       => 3,
                    'segment_text'  => 'exchange_wallet',
                )
