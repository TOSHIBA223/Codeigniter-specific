            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        <h1 class="m-t-0">Purchase Order No : <?php echo $uri->getSegment(4)?></h1>
                ...
                <div class="panel-footer text-right">
                    <a href="<?php echo base_url('customer/package/package_buy/'.$package->package_id);?>" class="btn btn-success"> Confirm</a>
                    <a href="<?php echo base_url('customer/package/package_list')?>" class="btn btn-danger"> <?php echo display('cancel');?></a>
                </div>
            </div>
