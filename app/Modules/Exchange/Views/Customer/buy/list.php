            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                             <a class="btn btn-success w-md m-b-5" href="<?php echo base_url("customer/buy/buy_form") ?>"><i class="fa fa-plus" aria-hidden="true"></i> <?php echo display('buy') ?></a>
                ...
                <table id="example" class="table  table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php 
                            echo $builder->select("coin_name")->where('coin_id', $value->coin_id)->get()->getrow()->coin_name; ?></td>
