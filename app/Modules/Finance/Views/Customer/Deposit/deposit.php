                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                        <div class="border_preview">
                            ...
                            <div class="form-group row">
                                <label for="deposit_amount" class="col-sm-4 col-form-label"><?php echo display('deposit_amount');?><span class='text-danger'> *</span></label>
                                <div class="col-sm-8">
                                    <input class="form-control" name="amount" required type="text" id="deposit_amount" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="deposit_payment_method" class="col-sm-4 col-form-label"><?php echo display('deposit_method');?><span class='text-danger'> *</span></label>
                                <div class="col-sm-8">
