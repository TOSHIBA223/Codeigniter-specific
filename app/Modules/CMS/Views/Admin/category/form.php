            ...
            <div class="card-body">
                ...
                <?php echo form_hidden('cat_id', esc($category->cat_id)) ?> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="cat_name_fr" value="<?php echo $category->cat_name_fr ?>" class="form-control" placeholder="<?php echo display('cat_name')." ".esc($web_language->name) ?>" type="text" id="cat_name_fr">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="cat_title1_fr" value="<?php echo $category->cat_title1_fr ?>" class="form-control" placeholder="<?php echo display('cat_title')." ".esc($web_language->name) ?>" type="text" id="cat_title1_fr">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="cat_title2_fr" value="<?php echo $category->cat_title2_fr ?>" class="form-control" placeholder="<?php echo display('cat_title')." ".esc($web_language->name) ?>" type="text" id="cat_title2_fr">
                        </div>
                    </div>
                    <div class="form-group row">
