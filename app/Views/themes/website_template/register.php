                ...
                <div class="col-sm-7 col-md-6">
                    <div class="">
                        ...
                        <div class="tab-content">
                            ...
                            <?php echo form_open(base_url('register'),'id="registerForm" name="registerForm"'); ?>
                                <div class="row">    
                                    <div class="col-sm-6">
                                        <div class="input">
                                ...
                                <div class="row">    
                                    ...
                                    <?php
                                       ...
                                       // $this->load->helper(array('cookie', 'url'));
                                        ...
                                        if (isset($ref) && ($ref!="")) {
                                            $user_id = $this->db->table('user_registration')->select('user_id')->where('user_id', $ref)->get()->getRow();
                                            if($user_id){
                                            ...
                                            if (!get_cookie('sponsor_id')) {
                                                $user_id = $this->db->table('user_registration')->select('user_id')->where('sponsor_id', 0)->get()->getRow();
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input">
                                            <select  class="selectpicker" data-width="100%" class="country input__field" id="country" name="country">
                                                ...
                                                ?>
                                                <option value="<?php echo esc($country["code"]) ?>"><?php echo esc($countryName)?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>    
                                ...
                                <div class="row">    
                                    <div class="col-sm-12">
                                        <div class="input">
                                            ...
                                            <?php echo display('your_password_at_global_crypto_are_encrypted_and_secured'); ?> <a target="_blank" href="<?php echo base_url(esc(@$article_image[0])); ?>" class="checkbox-link"><?php echo display('privacy_policy'); ?></a> <?php echo display('and'); ?> 
                                                <a target="_blank" href="<?php echo base_url(esc((@$article_image[0]))); ?>" class="checkbox-link"><?php echo display('terms_of_use'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="tab2">
                                <?php echo form_open(base_url('home/login'),'id="loginForm" '); ?>
                                <div class="row">    
                                    <div class="col-sm-12">
                                        <div class="input">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <?php echo form_open(base_url('home/forgotPassword'),'id="forgotPassword"'); ?>
